/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+basic+django+dns-zone-file+git+markup-templating+nginx+python+r+jsx+tsx+sql+typescript+visual-basic&plugins=line-numbers+file-highlight+show-language+highlight-keywords+toolbar+copy-to-clipboard */
